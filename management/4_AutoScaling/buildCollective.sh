...
cp $LAB_HOME/labs/management/4_AutoScaling_*/*.xml $WLPHOME/usr/servers/adminCenterController ;
cp $LAB_HOME/labs/management/4_AutoScaling_*/bootstrap.properties $WLPHOME/usr/servers/adminCenterController ;

cp -R $LAB_HOME/labs/management/4_AutoScaling_*/dy*  $WLPHOME/usr/servers/ ;
